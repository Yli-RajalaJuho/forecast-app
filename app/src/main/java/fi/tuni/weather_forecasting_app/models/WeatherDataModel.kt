...
data class WeatherCodeList(
    val weatherCodeList: List<WeatherCode> = listOf(
        ...
        WeatherCode(code = 53, conditions = "Moderate Drizzle", backgroundImage = R.drawable.rain),
        WeatherCode(code = 55, conditions = "Heavy Drizzle", backgroundImage = R.drawable.heavy_rain),
        ...
        WeatherCode(code = 61, conditions = "Slight Rain", backgroundImage = R.drawable.slight_rain),
        WeatherCode(code = 63, conditions = "Moderate Rain", backgroundImage = R.drawable.rain),
        ...
        WeatherCode(code = 80, conditions = "Slight Rain Showers", backgroundImage = R.drawable.slight_rain),
        WeatherCode(code = 81, conditions = "Moderate Rain Showers", backgroundImage = R.drawable.rain),
        WeatherCode(code = 82, conditions = "Violent Rain Showers", backgroundImage = R.drawable.heavy_rain),
